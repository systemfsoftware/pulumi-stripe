...
func Provider() tfbridge.ProviderInfo {
	...
	prov := tfbridge.ProviderInfo{
		...
		//
		//    - In provider/cmd/pulumi-tfgen-stripe/main.go, replace the
		...
		//
		//    - In provider/cmd/pulumi-resource-stripe/main.go, replace the
		...
		//
		//      	tfbridge.Main(context.Background(), "stripe", stripe.Provider(),
		...
		// convention is to have a function at "github.com/lukasaron/terraform-provider-stripe/provider".New
		...
		Golang: &tfbridge.GolangInfo{
			...
			ImportBasePath: path.Join(
				"github.com/systemfsoftware/pulumi-stripe/sdk/",
