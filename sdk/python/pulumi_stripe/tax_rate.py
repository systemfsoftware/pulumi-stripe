...
class TaxRateArgs:
    def __init__(__self__, *,
                 ...
                 tax_type: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a TaxRate resource.
        :param pulumi.Input[builtins.str] display_name: The display name of the tax rate, which will be shown to users.
        :param pulumi.Input[builtins.bool] inclusive: This specifies if the tax rate is inclusive or exclusive.
        :param pulumi.Input[builtins.float] percentage: This represents the tax rate percent out of 100.
        :param pulumi.Input[builtins.bool] active: Flag determining whether the tax rate is active or inactive (archived). Inactive tax rates cannot be used with new
               applications or Checkout Sessions, but will still work for subscriptions and invoices that already have it set.
        :param pulumi.Input[builtins.str] country: Two-letter country code (ISO 3166-1 alpha-2).
        :param pulumi.Input[builtins.str] description: An arbitrary string attached to the tax rate for your internal use only. It will not be visible to your customers.
        :param pulumi.Input[builtins.str] jurisdiction: The jurisdiction for the tax rate. You can use this label field for tax reporting purposes.It also appears on your
               customer’s invoice.
        ...
        :param pulumi.Input[builtins.str] state: ISO 3166-2 subdivision code, without country prefix. For example, “NY” for New York, United States.
        :param pulumi.Input[builtins.str] tax_type: The high-level tax type, such as vat or sales_tax.
        """
    ...
    def tax_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @tax_type.setter
    def tax_type(self, value: Optional[pulumi.Input[builtins.str]]):
...
class TaxRate(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            percentage: Optional[pulumi.Input[builtins.float]] = None,
            state: Optional[pulumi.Input[builtins.str]] = None,
            tax_type: Optional[pulumi.Input[builtins.str]] = None) -> 'TaxRate':
        """
    ...
    @property
    @pulumi.getter
    def jurisdiction(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The jurisdiction for the tax rate. You can use this label field for tax reporting purposes.It also appears on your
        customer’s invoice.
        """
    ...
    @property
    @pulumi.getter
    def livemode(self) -> pulumi.Output[builtins.bool]:
        """
        Has the value true if the object exists in live mode or the value false if the object exists in test mode.
        """
        return pulumi.get(self, "livemode")
    ...
    @property
    @pulumi.getter
    def percentage(self) -> pulumi.Output[builtins.float]:
        """
        This represents the tax rate percent out of 100.
        """
        return pulumi.get(self, "percentage")
    ...
    @property
    @pulumi.getter(name="taxType")
    def tax_type(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The high-level tax type, such as vat or sales_tax.
        """
        return pulumi.get(self, "tax_type")
