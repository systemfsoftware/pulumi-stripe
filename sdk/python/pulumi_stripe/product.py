...
class ProductArgs:
    def __init__(__self__, *,
                 ...
                 package_dimensions: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.float]]]] = None,
                 product_id: Optional[pulumi.Input[builtins.str]] = None,
                 shippable: Optional[pulumi.Input[builtins.bool]] = None,
                 statement_descriptor: Optional[pulumi.Input[builtins.str]] = None,
                 tax_code: Optional[pulumi.Input[builtins.str]] = None,
                 unit_label: Optional[pulumi.Input[builtins.str]] = None,
                 url: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a Product resource.
        :param pulumi.Input[builtins.bool] active: Whether the product is currently available for purchase. Defaults to true.
        :param pulumi.Input[builtins.str] description: The product’s description, meant to be displayable to the customer. Use this field to optionally store a long form
               explanation of the product being sold for your own rendering purposes.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] features: A list of up to 15 features for this product. These are displayed in pricing tables.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] images: A list of up to 8 URLs of images for this product, meant to be displayable to the customer.
        ...
        :param pulumi.Input[builtins.str] name: The product’s name, meant to be displayable to the customer. Whenever this product is sold via a subscription, name
               will show up on associated invoice line item descriptions.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.float]]] package_dimensions: The dimensions of this product for shipping purposes.
        :param pulumi.Input[builtins.str] product_id: Unique identifier for the object.
        :param pulumi.Input[builtins.bool] shippable: Whether this product is shipped (i.e., physical goods).
        :param pulumi.Input[builtins.str] statement_descriptor: An arbitrary string to be displayed on your customer’s credit card or bank statement. While most banks display this
        ...
        :param pulumi.Input[builtins.str] tax_code: A tax code ID. Supported values are listed in the TaxCode resource and at https://stripe.com/docs/tax/tax-categories.
        :param pulumi.Input[builtins.str] unit_label: A label that represents units of this product in Stripe and on customers’ receipts and invoices. When set, this will
               be included in associated invoice line item descriptions.
        :param pulumi.Input[builtins.str] url: A URL of a publicly-accessible webpage for this product.
        """
    ...
    def package_dimensions(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.float]]]]:
        """
    ...
    def package_dimensions(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.float]]]]):
    ...
    @property
    @pulumi.getter
    def shippable(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @shippable.setter
    def shippable(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "shippable", value)

    @property
    @pulumi.getter(name="statementDescriptor")
    def statement_descriptor(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def statement_descriptor(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "statement_descriptor", value)

    @property
    @pulumi.getter(name="taxCode")
    def tax_code(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @tax_code.setter
    def tax_code(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Product(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tax_code: Optional[pulumi.Input[builtins.str]] = None,
            unit_label: Optional[pulumi.Input[builtins.str]] = None,
            url: Optional[pulumi.Input[builtins.str]] = None) -> 'Product':
        """
    ...
    @property
    @pulumi.getter
    def features(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        A list of up to 15 features for this product. These are displayed in pricing tables.
        """
        return pulumi.get(self, "features")
    ...
    @property
    @pulumi.getter
    def images(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        A list of up to 8 URLs of images for this product, meant to be displayable to the customer.
        """
        return pulumi.get(self, "images")
    ...
    @property
    @pulumi.getter(name="packageDimensions")
    def package_dimensions(self) -> pulumi.Output[Optional[Mapping[str, builtins.float]]]:
        """
        The dimensions of this product for shipping purposes.
        """
        return pulumi.get(self, "package_dimensions")
    ...
    @property
    @pulumi.getter
    def shippable(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether this product is shipped (i.e., physical goods).
        """
        return pulumi.get(self, "shippable")
    ...
    @property
    @pulumi.getter(name="statementDescriptor")
    def statement_descriptor(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        An arbitrary string to be displayed on your customer’s credit card or bank statement. While most banks display this
        information consistently, some may display it incorrectly or not at all. This may be up to 22 characters. The statement
        description may not include <, >, \\, ", ’ characters, and will appear on your customer’s statement in capital
    ...
    @property
    @pulumi.getter(name="taxCode")
    def tax_code(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        A tax code ID. Supported values are listed in the TaxCode resource and at https://stripe.com/docs/tax/tax-categories.
        """
        return pulumi.get(self, "tax_code")
    ...
    @property
    @pulumi.getter(name="unitLabel")
    def unit_label(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        A label that represents units of this product in Stripe and on customers’ receipts and invoices. When set, this will
        be included in associated invoice line item descriptions.
        """
