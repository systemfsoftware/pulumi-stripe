...
class ShippingRateArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] display_name: The name of the shipping rate, meant to be displayable to the customer. This will appear on CheckoutSessions.
        :param pulumi.Input['ShippingRateFixedAmountArgs'] fixed_amount: Describes a fixed amount to charge for shipping. Must be present for now.
        :param pulumi.Input[builtins.bool] active: Whether the shipping rate can be used for new purchases. Defaults to true.
        ...
        :param pulumi.Input[builtins.str] tax_behavior: Specifies whether the rate is considered inclusive of taxes or exclusive of taxes. One of inclusive, exclusive, or
               unspecified.
        :param pulumi.Input[builtins.str] tax_code: A tax code ID. The Shipping tax code is txcd_92010001.
        :param pulumi.Input[builtins.str] type: The type of calculation to use on the shipping rate. Can only be fixed_amount for now
        """
...
class ShippingRate(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[builtins.bool] active: Whether the shipping rate can be used for new purchases. Defaults to true.
        :param pulumi.Input[builtins.str] display_name: The name of the shipping rate, meant to be displayable to the customer. This will appear on CheckoutSessions.
        :param pulumi.Input[Union['ShippingRateFixedAmountArgs', 'ShippingRateFixedAmountArgsDict']] fixed_amount: Describes a fixed amount to charge for shipping. Must be present for now.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] metadata: Set of key-value pairs that you can attach to an object. This can be useful for storing additional information about the
               object in a structured format.
        :param pulumi.Input[builtins.str] tax_behavior: Specifies whether the rate is considered inclusive of taxes or exclusive of taxes. One of inclusive, exclusive, or
               unspecified.
    ...
    def get(resource_name: str,
            ...
            tax_behavior: Optional[pulumi.Input[builtins.str]] = None,
            tax_code: Optional[pulumi.Input[builtins.str]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None) -> 'ShippingRate':
        """
    ...
    @property
    @pulumi.getter(name="taxBehavior")
    def tax_behavior(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Specifies whether the rate is considered inclusive of taxes or exclusive of taxes. One of inclusive, exclusive, or
        unspecified.
        """
