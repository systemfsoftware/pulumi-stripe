...
namespace Pulumi.Stripe
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Stripe.version.txt");
    ...
    internal sealed class StripeResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public StripeResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
